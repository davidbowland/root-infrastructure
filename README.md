...
Infrastructure as Code for root resources.

## Setup

The `administrator` role and [AWS SAM CLI](https://aws.amazon.com/serverless/sam/) are required to deploy this project.
